...
<div class="haupt" style="width:700px; height: 547px;" >
  ...
  <div class="denglujiemian" style="background-color:#e5faff;opacity: 0.5;width:400px;height: 300px;position: relative;bottom: 450px;left:450px;border-radius: 30px;">
    ...
    <input type="submit" onclick="Login()"  value="Login" style="font-weight: bold; border-color: #00aeef; color: #0c5460;border-radius: 30px;height: 40px;width: 70px;position: relative;top:100px;left:30px"/>

  </form> </div>

  <!--    密码错误提醒-->
  <span class="ErrorPasswort" style="position: relative;width:200px;height:40px;bottom: 550px;left:480px;color:red"></span>
  ...
  <p style="position: relative;left:570px;bottom: 497px">Hast du noch kein Konto?<a href="#" style="color:dodgerblue" onclick="Zhuce()"><strong>&nbspRegister</strong></a></p>
  ...
  <div class="denglujiemian2" id="ghg" style="display: none; background-color:#e5faff;opacity: 1;width:400px;height: 400px;position: relative;bottom: 850px;left:450px;border-radius: 30px;">
    ...
    <form value="rigisterSubmit">
      ...
      <input class="inputarea2"  type="submit"  value="Submit" style="font-weight: bold;width:70px" onclick="Tijiaozhuce()" />
